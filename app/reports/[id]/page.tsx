        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-0.5 bg-blue-50 text-blue-700 rounded-full text-xs font-semibold uppercase tracking-wider border border-blue-100">
                {data.category}
              </span>
          ...
          <h2 className="text-sm font-bold text-gray-900 truncate max-w-[200px] sm:max-w-xs">
            {data.product_name}
          </h2>
        </div>
      </div>
